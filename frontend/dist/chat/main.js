...
class HttpService {
    ...
    getAllMessages(userId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield this.hs.get(this.url + "/message/getAllMessages/" + userId).toPromise();
        });
    }
    ...
    saveChatRoomUserPHPBackend(roomId, userId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.hs.post(this.url + '/chatroomuser/addChatRoomUser' + body.toString(), httpOptions).toPromise();
        });
    }
}
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var src_app_entities_room__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/entities/room */ "Q4WR");
/* harmony import */ var _services_websocket_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/websocket.service */ "Gyf/");
...
function ChatComponent_mat_card_22_Template(rf, ctx) { if (rf & 1) {
...
class ChatComponent {
    ...
    updateChat(newMessageObject) {
        ...
        if (this.allRooms == null) {
            this.allRooms.push(new src_app_entities_room__WEBPACK_IMPORTED_MODULE_2__["Room"](this.allRooms.length + 1, [this.toJSON["message"]], [this.hs.loggedInUsername, this.toJSON["username"]]));
        }
            ...
            var newRoom = new src_app_entities_room__WEBPACK_IMPORTED_MODULE_2__["Room"](this.allRooms.length + 1, [this.toJSON["message"]], [this.hs.loggedInUsername, this.toJSON["username"]]);
            //createRoom
    ...
    createRoom(creator, roomName) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let helpVar = new src_app_entities_room__WEBPACK_IMPORTED_MODULE_2__["Room"](Number(createdRoomId), [], [this.hs.loggedInUsername, this.hs.otherUser.username]);
    ...
    loadAllMessages() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            var responseData = yield this.hs.getAllMessages(Number(this.hs.loggedInUserId));
            ...
            for (let i = 0; i < allMessages.length; i++) {
                ...
                if (this.allRooms.length == 0) {
                    ...
                    var otherChatter = yield this.hs.getUserById(allMessages[i]["reciever_user_id"]);
                    this.allRooms.push(new src_app_entities_room__WEBPACK_IMPORTED_MODULE_2__["Room"](firstRoomToAdd, messages, [this.hs.loggedInUsername, otherChatter["username"]]));
                    this.users.push(otherChatter["username"]);
                    loadedRoomIds.push(allMessages[i]["room_id"]);
                }
                else {
                    if (!loadedRoomIds.includes(allMessages[i]["room_id"])) {
                        for (let y = 0; y < allMessages.length; y++) {
                            if (allMessages[i]["room_id"] == allMessages[y]["room_id"]) {
                                messages.push(allMessages[y]["message"]);
                            }
                        }
                        var otherChatter = yield this.hs.getUserById(allMessages[i]["reciever_user_id"]);
                        console.log(otherChatter);
                        this.allRooms.push(new src_app_entities_room__WEBPACK_IMPORTED_MODULE_2__["Room"](allMessages[i]["room_id"], messages, [this.hs.loggedInUsername, otherChatter["username"]]));
                        this.users.push(otherChatter["username"]);
                        loadedRoomIds.push(allMessages[i]["room_id"]);
                    }
...
ChatComponent.ɵfac = function ChatComponent_Factory(t) { return new (t || ChatComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_websocket_service__WEBPACK_IMPORTED_MODULE_3__["WebsocketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"])); };
ChatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ChatComponent, selectors: [["app-chat"]], decls: 31, vars: 5, consts: [[1, "example-container"], ["mode", "side", "opened", "", 1, "sideNav"], [1, "chats_tab"], ["mat-tab-label", ""], [4, "ngFor", "ngForOf"], [1, "mat-form-field"], ["matInput", "", "name", "username", 3, "ngModel", "ngModelChange"], ["mat-stroked-button", "", "color", "warn", 1, "mat-form-field", 3, "click"], [1, "chat", 3, "hidden"], [1, "message-card"], ["class", "single_message_card", 4, "ngFor", "ngForOf"], ["color", "warn", 1, "mat-form-field"], [1, "msg_label"], ["matInput", "", "name", "message", 3, "ngModel", "ngModelChange"], ["mat-button", "", 1, "send_btn", 3, "click"], [1, "example-tab-icon"], [1, "users_icon"], ["mat-list-item", "", 1, "users_btn", 3, "click"], [1, "single_message_card"]], template: function ChatComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](9, "mat-tab");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](10, ChatComponent_ng_template_10_Template, 2, 0, "ng-template", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](15, "Enter Username");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](16, "input", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function ChatComponent_Template_input_ngModelChange_16_listener($event) { return ctx.username = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](17, "button", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ChatComponent_Template_button_click_17_listener() { return ctx.saveUsername(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](18, "Search for User");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](19, "div", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](20, "form");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](21, "mat-card", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](22, ChatComponent_mat_card_22_Template, 2, 1, "mat-card", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](23, "mat-form-field", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](24, "mat-label", 12);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function ChatComponent_Template_input_ngModelChange_26_listener($event) { return ctx.msg = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](27, "button", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ChatComponent_Template_button_click_27_listener() { return ctx.sendMsg(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](28, " Senden ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](29, "mat-icon");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](30, "send");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ChatComponent, [{
    ...
    }], function () { return [{ type: _services_websocket_service__WEBPACK_IMPORTED_MODULE_3__["WebsocketService"] }, { type: src_app_services_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"] }]; }, null); })();
